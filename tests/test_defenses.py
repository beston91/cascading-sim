...
from graph_tiger.defenses import (
...
def test_method_selection():
    ...
    ground_truth = {  # karate graph top 4 nodes to be monitored or top 4 edges to added/rewired
        ...
        "rb_node": [0, 33, 32, 2],
        "rnd_node": [14, 19, 3, 27],
        "add_edge_pr": {"added": [(33, 0), (0, 32), (33, 2), (33, 1)]},
        "add_edge_eig": {"added": [(33, 0), (33, 2), (0, 32), (33, 1)]},
        "add_edge_deg": {"added": [(33, 0), (0, 32), (33, 2), (33, 1)]},
        "add_edge_random": {"added": [(14, 19), (16, 22), (29, 20), (31, 15)]},
        "add_edge_preferential": {"added": [(11, 9), (12, 14), (15, 16), (17, 18)]},
        "rewire_edge_random": {
        ...
        if get_defense_category(method) == "node":
            ...
            if "removed" in values:
                assert np.array_equal(
                    values["removed"], ground_truth[method]["removed"]
                )
